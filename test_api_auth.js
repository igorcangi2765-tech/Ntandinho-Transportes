...
async function testApiEndpoint() {
  ...
  // Importar servidor compilado dist/server.js ou testar via HTTP
  const app = require('./api/dist/server.js');

  // Aguardar 1 segundo para garantir inicialização da porta
  ...
  try {
    ...
    // TESTE 3: Rota Inexistente na API (/api/inexistente)
