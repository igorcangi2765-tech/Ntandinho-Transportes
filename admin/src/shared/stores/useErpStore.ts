...
export const useErpStore = create<ErpState>((set, get) => ({
  companyProfile: {
    ...
    slogan: "Transporte e Logística em Moçambique",
  ...
  customers: [
    {
      ...
      city: 'Maputo',
      isCorporate: true,
      creditLimitMzn: 1500000,
      totalSpentMzn: 406000,
      status: 'ATIVO',
    ...
    },
    {
      ...
      city: 'Matola',
      isCorporate: true,
      creditLimitMzn: 2000000,
      totalSpentMzn: 556800,
      status: 'ATIVO',
    ...
    },
    {
      ...
      city: 'Tete',
      isCorporate: true,
      creditLimitMzn: 1200000,
      totalSpentMzn: 320000,
      status: 'ATIVO',
    ...
    },
    {
      ...
      city: 'Matola',
      isCorporate: true,
      creditLimitMzn: 1000000,
      totalSpentMzn: 285000,
      status: 'ATIVO',
    ...
    },
    {
      ...
      city: 'Matola',
      isCorporate: true,
      creditLimitMzn: 800000,
      totalSpentMzn: 195000,
      status: 'ATIVO',
    ...
    },
    {
      ...
      city: 'Nampula',
      isCorporate: true,
      creditLimitMzn: 600000,
      totalSpentMzn: 160000,
      status: 'ATIVO',
