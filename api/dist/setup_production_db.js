...
async function main() {
    ...
    const isPasswordCorrect = bcryptjs_1.default.compareSync('Admin2026!', adminUser.password);
    ...
    const loginResult = await auth_service_1.AuthService.login('admin@ntandinho.co.mz', 'Admin2026!', '127.0.0.1', 'NodeSetupValidator');
...
`;
    ...
    const dbSqlPath1 = path_1.default.join(__dirname, '../database.sql');
    const dbSqlPath2 = path_1.default.join(__dirname, '../ntandinho_hostinger_database.sql');
    const dbSqlPathProd1 = path_1.default.join(__dirname, '../../dist_production/public_html/api/database.sql');
    const dbSqlPathProd2 = path_1.default.join(__dirname, '../../dist_production/public_html/api/ntandinho_hostinger_database.sql');
    fs_1.default.writeFileSync(dbSqlPath1, sqlDump, 'utf8');
    fs_1.default.writeFileSync(dbSqlPath2, sqlDump, 'utf8');
    if (fs_1.default.existsSync(path_1.default.dirname(dbSqlPathProd1))) {
        fs_1.default.writeFileSync(dbSqlPathProd1, sqlDump, 'utf8');
        fs_1.default.writeFileSync(dbSqlPathProd2, sqlDump, 'utf8');
    }
